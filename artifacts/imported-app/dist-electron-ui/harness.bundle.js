...
(() => {
      ...
      function mapIntoArray(children, array, escapedPrefix, nameSoFar, callback) {
        ...
        if (invokeCallback)
          return callback = callback(children), invokeCallback = "" === nameSoFar ? "." + getElementKey(children, 0) : nameSoFar, isArrayImpl(callback) ? (escapedPrefix = "", null != invokeCallback && (escapedPrefix = invokeCallback.replace(userProvidedKeyEscapeRegex, "$&/") + "/"), mapIntoArray(callback, array, escapedPrefix, "", function(c) {
            return c;
          })) : null != callback && (isValidElement4(callback) && (callback = cloneAndReplaceKey(
            callback,
    ...
    "../../node_modules/react-dom/cjs/react-dom-client.production.js"(exports) {
      ...
      function createChildReconciler(shouldTrackSideEffects) {
        ...
        function updateElement(returnFiber, current, element, lanes) {
          ...
          if (null !== current && (current.elementType === elementType || "object" === typeof elementType && null !== elementType && elementType.$$typeof === REACT_LAZY_TYPE3 && resolveLazy(elementType) === current.type))
                ...
                a: {
                  for (var key = newChild.key; null !== currentFirstChild; ) {
                    if (currentFirstChild.key === key) {
                      ...
                      } else if (currentFirstChild.elementType === key || "object" === typeof key && null !== key && key.$$typeof === REACT_LAZY_TYPE3 && resolveLazy(key) === currentFirstChild.type) {
                        deleteRemainingChildren(
                          returnFiber,
                          currentFirstChild.sibling
                        );
      ...
      var isomorphicReactPackageVersion$jscomp$inline_1785 = React17.version;
  ...
  // src/components/views/startup-card.tsx
  ...
  var Power = createLucideIcon("power", __iconNode);
  ...
  var use2 = React6[" use ".trim().toString()];
  ...
  function createSlot2(ownerName) {
    ...
    const Slot2 = React6.forwardRef((props, forwardedRef) => {
      ...
      if (slottable) {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React6.isValidElement(newElement) ? React6.cloneElement(newElement, void 0, newChildren) : null });
      }
  ...
  var Separator = React8.forwardRef((props, forwardedRef) => {
  ...
  function createSlot3(ownerName) {
    ...
    const Slot2 = React14.forwardRef((props, forwardedRef) => {
      ...
      if (slottable) {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React14.isValidElement(newElement) ? React14.cloneElement(newElement, void 0, newChildren) : null });
      }
  ...
  var Switch = React16.forwardRef(
    (props, forwardedRef) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(SwitchProvider, { scope: __scopeSwitch, checked, disabled, children: [
  ...
  var SwitchThumb = React16.forwardRef(
    (props, forwardedRef) => {
  ...
  var SwitchBubbleInput = React16.forwardRef(
    ({
      __scopeSwitch,
      control,
      checked,
  ...
  // src/components/views/startup-card-labels.ts
  var QUIT_ON_CLOSE_SWITCH_LABEL = "Quit ScriptureLive AI when the main window is closed";
  ...
  function StartupCard() {
    ...
    const [quitOnClose, setQuitOnCloseState] = (0, import_react4.useState)(null);
    const [closeBusy, setCloseBusy] = (0, import_react4.useState)(false);
    ...
    (0, import_react4.useEffect)(() => {
      ...
      const bridge = window.scriptureLive;
      let cancelled = false;
      bridge?.launchAtLogin?.get?.().then((res) => {
      ...
      bridge?.quitOnClose?.get?.().then((res) => {
        if (!cancelled) setQuitOnCloseState(res.value === true);
      }).catch(() => {
      });
      return () => {
        cancelled = true;
    ...
    const handleToggle = async (next) => {
      ...
      try {
        ...
        toast.success(
          next ? "ScriptureLive AI will start automatically when you log in." : "Launch at startup turned off."
        );
      } catch (err) {
    ...
    const handleQuitOnCloseToggle = async (next) => {
      const bridge = window.scriptureLive;
      ...
      try {
        ...
        toast.success(
          next ? "Closing the window will quit ScriptureLive AI." : "Closing the window will keep ScriptureLive AI running in the tray."
        );
      } catch (err) {
        toast.error(
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(Card, { className: "bg-card border-border", children: [
      /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(CardHeader, { className: "pb-3", children: /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Power, { className: "h-5 w-5 text-primary" }),
        /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(CardTitle, { className: "text-base", children: "Startup & Shutdown" }),
          /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(CardDescription, { children: "When ScriptureLive AI starts, and what happens when you close the window" })
        ] })
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(CardContent, { className: "space-y-3", children: [
        /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { className: "flex items-center justify-between gap-3", children: [
          /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Label2, { className: "text-sm font-medium", children: "Launch at startup" }),
            /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("p", { className: "text-xs mt-0.5 text-muted-foreground", children: info === null ? "Checking\u2026" : supported ? "When on, ScriptureLive AI starts in the system tray when you log in \u2014 NDI is already running before you double-click anything. Click the tray icon to bring up the main window." : info.reason ?? "Not available on this system." })
          ] }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Separator2, {}),
        /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { className: "flex items-center justify-between gap-3", children: [
          /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Label2, { className: "text-sm font-medium", children: "When I close the window, also quit the app" }),
            /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("p", { className: "text-xs mt-0.5 text-muted-foreground", children: !isElectron ? "This setting is only available in the desktop app." : quitOnClose === null ? "Checking\u2026" : "Off (recommended) keeps ScriptureLive AI running in the system tray when you click the X button \u2014 NDI and the secondary screen stay live. Turn ON if you want the X button to fully quit the app and free its memory (single-monitor setups, kiosks)." })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
            Switch2,
            {
  ...
  (0, import_client.createRoot)(container).render(
    /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(import_jsx_runtime16.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(StartupCard, {}),
